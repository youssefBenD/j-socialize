		...
		<header class="header black-bg">
			...
			<div class="nav notify-row" id="top_menu">
				...
				<ul class="nav top-menu">
					<li><a>Ajouter un événement</a></li>
				...
				<ul class="sidebar-menu" id="nav-accordion">
					...
					<li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li><a class="logout"  href="<c:url value='/evenement/nouveau'/>">Créer événement</a></li>
                          <li><a class="logout" href="<c:url value='/evenement/liste'/>">Consulter événements</a></li>
                      </ul>
                  </li>
					...
					<li class="sub-menu"><a href="/stages"> <i
							class="fa fa-users"></i> <span>Stages</span>
					</a></li>
      ...
      *********************************************************************************************************************************************************** -->
		<section id="main-content">
			<section class="wrapper">
				<h3>
					<i class="fa fa-angle-right"></i> Création Evénement JCI
				</h3>
					...
					<div class="col-lg-10">
						<div class="form-panel">
							<form class="form-horizontal style-form" id="form"
								action="<c:url value='/evenement/submit'/>" method="POST">
								...
								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label">Lieu de
										l'événement</label>
									<div class="col-sm-10">
										<input type="text" name="lieu" class="form-control round-form">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label">Jour</label>
									<div class="col-sm-10">
										<input type="text" name="jour" class="form-control round-form">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label">Mois</label>
									<div class="col-sm-10">
										<input type="text" placeholder="Exemple Mars: 03" name="mois" class="form-control round-form">
									</div>
								</div>
								<div class="form-group">
