		...
		<header class="header black-bg">
			...
			<div class="nav notify-row" id="top_menu">
				...
				<ul class="nav top-menu">
					<li><a>Evénements JCI à venir</a></li>
			...
			<div id="sidebar" class="nav-collapse ">
				...
				<ul class="sidebar-menu" id="nav-accordion">
					...
					<li class="sub-menu"><a class="active" href="javascript:;">
							<i class="fa fa-tasks"></i> <span>Evenements</span>
					</a>
						<ul class="sub">
			...
			<section class="wrapper">
				<div class="row mt">
					...
					<div class="col-lg-12 col-md-12 col-sm-12">
						...
						<div class="showback">
							<h4>
								<i class="fa fa-angle-right"></i> Evénements
							</h4>
							<c:forEach items="${evenements}" var="evenement">
								<div class="alert alert-success">
									...
									<div>
										<b>Lieu:</b>${evenement.lieu}
									</div>
									<div>
										<b>Nombre participants:</b> ${evenement.nbrParticipant }
									</div>
									<div>
										<b>OLM organisatrice:</b> ${evenement.olm}
									</div>

									<button class="btn btn-theme " href="ajouterPhoto.html"
										type="submit">
				...
				<a href="/mongo/evenement/nouveau"
					class="btn btn-primary btn-lg btn-block" role="button">Créer un
					événement</a>
				<!--/ row -->
			</section>
			<! --/wrapper -->
